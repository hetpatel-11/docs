...
1. Installed the browser-use extra: `pip install auth-agent-sdk[browser-use]`
2. Have version 2.5.1 or later: `pip install --upgrade auth-agent-sdk[browser-use]`

**Alternative import** (for older versions < 2.5.1):
```python
