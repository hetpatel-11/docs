...
<ResponseField name="email" type="string">
  User's email address (only included if `email` or `openid` scope was granted)
</ResponseField>

<ResponseField name="name" type="string">
  User's full name (only included if `email` or `openid` scope was granted)
</ResponseField>
...
|-------|----------------|
| None | Only `sub` |
| `email` or `openid` | `sub`, `email`, `name` |
