...
<img className="block dark:hidden" src="/logo/light.png" alt="Auth Agent Logo" />
<img className="hidden dark:block" src="/logo/dark.png" alt="Auth Agent Logo" />
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="robot"
    href="/guides/integration-scenarios"
  >
  ...
  <Card
    ...
    icon="arrows-rotate"
    href="/api-reference/oauth/token"
  >
    Automatic refresh token rotation for enhanced security
  </Card>
  <Card
    title="User Context Sharing"
    icon="user"
...
<Card
  title="Learn more about integration scenarios"
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="globe"
    href="/guides/website-quickstart"
  >
  ...
  <Card
    title="Examples"
    icon="book-code"
    href="https://github.com/auth-agent/auth-agent"
  >
