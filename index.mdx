...
<img className="block dark:hidden" src="/assets/logo.png" alt="Auth Agent Logo" />
<img className="hidden dark:block" src="/assets/logo.png" alt="Auth Agent Logo" />
...
<CardGroup cols={2}>
  ...
  >
    Real-world code examples for common frameworks
  </Card>
</CardGroup>
